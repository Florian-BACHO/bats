...
def get_predictions(n_output_spikes: cp.ndarray) -> cp.ndarray:
    return cp.argmax(n_output_spikes, axis=1)
...
if __name__ == "__main__":
    ...
    csvfile = open("./convergence_count.csv", 'w', newline='')
